...
<div class="wrap">
  ...
  <div class="body">
    <h1>Someone viewed your contact details! 🔔</h1>
    <p>Hi {{ $workerUser->name }}, someone just unlocked your contact information on Vastoq. Expect a call or message soon!</p>
    <p>Your profile: <strong>{{ $worker->category }}</strong> in {{ $worker->locality }}</p>
    <p>Keep your phone handy — potential clients contact directly after unlocking.</p>
    <a href="{{ env('FRONTEND_URL', 'https://vastoq.com') }}/worker/dashboard" class="btn">View Dashboard →</a>
  </div>
  <div class="footer">
